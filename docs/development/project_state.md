...
#173 ci: workflow fix for pending-check defer and eligibility confirmation (workflow fix introduced by follow-up to PR #172; documentation updated in follow-up PRs)
