...
#175 docs/process: validate pending-check defer behavior in docs-only auto-merge (tiny docs-only validation PR for Issue #174 after PR #172; documentation only)
```
