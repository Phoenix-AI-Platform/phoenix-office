...
- [Orchestration approval boundary](orchestration_approval_boundary.md) documents contract-only approved, rejected, and needs-changes decisions before any future execution layer.
