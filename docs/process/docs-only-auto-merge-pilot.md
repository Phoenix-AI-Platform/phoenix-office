...
PR #173 recorded the pending-check defer and eligibility confirmation sequencing in the live pilot path, validating that the pilot correctly gates on the eligibility confirmation job from the dry-run.
