...
def test_sample_north_prairie_records_to_docx_workflow(
    ...
    assert "Customer: Sample North Prairie Customer" in captured.out
    assert "Item Description: Removal of two 550 Gallon Aboveground Storage Tanks" in captured.out
